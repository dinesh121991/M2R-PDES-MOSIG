...
Parallel,Distributed and Embedded System \optionB  \end{center}\vfill}
% End of title page formatting

\option{$<$PDES$>$}
\title{ Multi Parameter Resource Selection in SLURM Based On LAYOUTS Framework }%\\\vspace{-1ex}\rule{10ex}{0.5pt} \\sub-title} 
\author{Dineshkumar RAJAGOPAL}
\date{ $<$1st September 2015$>$} % Delete this line to display the current date
\jury{
Research project performed at $<$BULL-SAS,Grenoble$>$ \\\medskip
Under the supervision of:\\
$<$Dr.Yiannis GEORGIOU, BULL-SAS$>$\\\medskip
